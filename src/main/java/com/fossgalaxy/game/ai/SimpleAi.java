...
public class SimpleAi extends AbstractionLayerAI{
    ...
    @ObjectDef("SimpleAI")
    public SimpleAi(EntityType baseType, EntityType towerType, EntityType workerType, EntityType unitType, EntityType prodType) {
    ...
    @ObjectDef("SimpleAiP")
    public SimpleAi(EntityType baseType, EntityType towerType, EntityType workerType, EntityType prodType) {
    ...
    public AI clone() {
        return new SimpleAi(baseType,towerType,workerType, unitType,prodType);
    }
