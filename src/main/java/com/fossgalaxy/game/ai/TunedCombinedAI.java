...
public class TunedCombinedAI extends AbstractionLayerAI{
    ...
    @ObjectDef("TunedAi")
    public TunedCombinedAI(EntityType baseType, EntityType towerType, EntityType workerType, EntityType unitType, EntityType prodType, EntityType tankType) {
    ...
    @ObjectDef("TunedAiP")
    public TunedCombinedAI(EntityType baseType, EntityType towerType, EntityType workerType, EntityType prodType, EntityType tankType) {
    ...
    public void baseBehavior(Entity base, int player,List<Entity> workers, GameState pgs, List<Entity> tanks) {
        ...
        // if we get less tanks than other player's max entities
        if(tanks.size() < pgs.getOwnedEntities(OtherPlayer).size()){
